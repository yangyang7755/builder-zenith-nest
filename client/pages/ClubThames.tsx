    ...
    <div className="min-h-screen bg-white font-cabin max-w-md mx-auto relative">
      ...
      <div className="overflow-y-auto pb-20 px-6">
        ...
        <div className="text-center mb-6">
          <img
            src="https://images.unsplash.com/photo-1544717297-fa95b6ee9643?w=200&h=200&fit=crop"
          ...
          <div className="space-y-3">
            <div className="border-2 border-gray-200 rounded-lg p-4">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600 mb-1">
                ...
                <span>Saturday, 27 January • 9:00 AM</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <MapPin className="w-4 h-4" />
                <span>Putney Bridge</span>
              </div>
            </div>
            ...
            <div className="border-2 border-gray-200 rounded-lg p-4">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600 mb-1">
                <Calendar className="w-4 h-4" />
                <span>Sunday, 28 January • 10:00 AM</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <MapPin className="w-4 h-4" />
                <span>Westminster Bridge</span>
              </div>
            </div>
          </div>
        </div>
