                  ...
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        <span className="text-xs text-gray-500 ml-1">Holly's review: "Excellent workshop!"</span>
                      </div>
                    </div>
                ...
                <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-explore-green">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Holly organized • Feb 5, 2025</p>
                ...
                <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-explore-green">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Holly organized • Jan 28, 2025</p>
                      <div className="flex items-center gap-2 mt-2">
                        <div className="flex items-center gap-1">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star
        ...
        <div className="fixed inset-0 z-50 bg-white">
          ...
          <div className="p-4">
            <div className="space-y-4">
              {/* Demo followers */}
              {[
                { name: "Sarah Chen", university: "LSE", image: "https://images.unsplash.com/photo-1494790108755-2616b612b647?w=40&h=40&fit=crop" },
                { name: "Mike Johnson", university: "UCL", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop" },
                { name: "Emma Wilson", university: "Oxford", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=40&h=40&fit=crop" }
              ].map((follower, index) => (
        ...
        <div className="fixed inset-0 z-50 bg-white">
          ...
          <div className="p-4">
            <div className="space-y-4">
              {/* Demo following */}
              {[
                { name: "London Climbing", university: "Academy", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=40&h=40&fit=crop" },
                { name: "Peak Adventures", university: "Outdoors", image: "https://images.unsplash.com/photo-1551632811-561732d1e306?w=40&h=40&fit=crop" },
                { name: "Mountain Guides", university: "Training", image: "https://images.unsplash.com/photo-1609952267550-63d4e3b30d38?w=40&h=40&fit=crop" }
              ].map((followed, index) => (
                <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
