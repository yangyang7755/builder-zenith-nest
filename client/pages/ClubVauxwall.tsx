...
import { MapPin, Users, Calendar, Info, X, Trophy } from "lucide-react";

export default function ClubVauxwall() {
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex items-center gap-2 text-sm font-cabin">
              ...
              <span>15m high walls</span>
            </div>
            <div className="flex items-center gap-2 text-sm font-cabin">
              <span className="text-explore-green">✓</span>
              <span>Bouldering area</span>
            </div>
            <div className="flex items-center gap-2 text-sm font-cabin">
              <span className="text-explore-green">✓</span>
        ...
        <div className="mb-6">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <ul className="space-y-2 text-sm text-black font-cabin">
              <li>• Valid climbing centre membership</li>
              <li>• Basic bouldering experience recommended</li>
              <li>• Own climbing shoes (rental available)</li>
              <li>• Commitment to safety protocols</li>
            </ul>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg w-full max-w-sm p-6">
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600 font-cabin mb-3">
                Send a message to VauxWall East admins (optional):
              </p>
              <textarea
                value={joinMessage}
                onChange={(e) => setJoinMessage(e.target.value)}
                placeholder="Hi! I'd like to join VauxWall East Climbing Centre..."
