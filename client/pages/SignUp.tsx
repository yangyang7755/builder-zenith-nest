    ...
    <div className="min-h-screen bg-white font-cabin max-w-md mx-auto relative">
      <div className="flex flex-col justify-center items-center px-7 py-16 min-h-screen">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-black font-cabin mb-2">Wildpals</h2>
        </div>
        ...
        <div className="w-full max-w-sm space-y-4">
          ...
          <div className="flex items-center gap-3 pt-4">
            ...
            />
            <label htmlFor="terms-agreement" className="text-sm text-black font-cabin cursor-pointer">
