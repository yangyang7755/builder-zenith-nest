  ...
  const enhancedActivities = useMemo(
    () => [
      ...
      },
      {
        ...
        description:
          "Learn advanced techniques with certified instructors. Multi-pitch climbing and anchor building.",
        participants: 8,
        maxParticipants: 12,
        difficulty: "Advanced",
      ...
      },
      {
        ...
        description:
          "Challenging hike to Box Hill summit with stunning views. Includes lunch stop at the top.",
        participants: 18,
        maxParticipants: 30,
      ...
      },
      {
        ...
        description:
          "Learn to surf with qualified instructors. All equipment provided including wetsuits.",
        participants: 4,
        maxParticipants: 10,
        difficulty: "Beginner",
                  ...
                  <div className={viewMode === "grid" ? "" : "flex gap-4"}>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-start justify-between mb-2">
                        <h3
                          className={`font-bold text-black font-cabin ${
                      ...
                      {/* Organizer */}
                      <p
                        className={`text-explore-green font-cabin font-medium ${
                      ...
                      {/* Meta Info */}
                      <div
                        className={`space-y-1 ${viewMode === "grid" ? "text-xs" : "text-sm"}`}
                      >
                        ...
                        <div className="flex items-center gap-1 text-gray-600">
                          ...
                          <span className="font-cabin line-clamp-1">
                            {activity.location}
                          </span>
                        </div>
                        <div className="flex items-center gap-1 text-gray-600">
