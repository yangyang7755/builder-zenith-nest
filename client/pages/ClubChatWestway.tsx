  ...
  const [messages, setMessages] = useState([
    {
      ...
      user: "Arthur",
      message:
        "New routes set this week! The blue V4 on the overhang is incredible 🧗‍♀️",
      time: "3 hours ago",
      type: "text",
      avatar:
    ...
    },
    {
      ...
      user: "Ben",
      message:
        "Last night's bouldering comp was epic! Check out these action shots 📸",
      time: "1 hour ago",
      type: "text",
      avatar:
    ...
    },
    {
      ...
      user: "Dan",
      message:
        "💰 Gear sharing cost: Rope rental for weekend outdoor trip - £45 split 3 ways = £15 each",
      time: "30 minutes ago",
      type: "bill",
      billAmount: "£15",
    ...
    },
    {
      ...
      user: "Mike",
      message:
        "Don't worry Sarah! Next comp is in 2 weeks. Friday Women's+ night tomorrow if you're free!",
      time: "20 minutes ago",
      type: "text",
      avatar:
        "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face",
    },
    {
      ...
      user: "You",
      message:
        "Count me in for the rope rental! And definitely joining Friday night 🧗‍♀️",
      time: "Just now",
      type: "text",
      avatar:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face",
