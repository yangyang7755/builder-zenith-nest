      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.tagsContainer}>
            {profileData.sports.map((sport, index) => (
              <View key={index} style={styles.sportTag}>
                <Text style={styles.sportTagText}>{getSportEmoji(sport)} {sport}</Text>
              </View>
            ))}
          ...
          <View style={styles.tabContainer}>
            {profileData.sports.map((sport, index) => (
              ...
              >
                <Text style={[
                  styles.tabText,
                  activeSportTab === sport.toLowerCase() && styles.activeTabText
                ]}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.activityCard}>
            <Text style={styles.activityTitle}>🧗 Westway Climbing Session</Text>
            <Text style={styles.activitySubtitle}>Completed • Jan 15, 2024</Text>
          </View>
          
          <View style={styles.activityCard}>
            <Text style={styles.activityTitle}>🚴 Richmond Park Cycling</Text>
            <Text style={styles.activitySubtitle}>Completed • Jan 10, 2024</Text>
          </View>
        </View>
