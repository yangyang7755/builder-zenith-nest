  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 16 }}>
        <Image
          source={{
            uri: "https://images.unsplash.com/photo-1557169448-81bbe2b9741d?w=1200",
          }}
          style={styles.cover}
        />
        <View style={{ padding: 16 }}>
          ...
          <Text style={styles.subtitle}>
            Exclusive offers and events for Wildpals
          </Text>
          <TouchableOpacity style={styles.primary}>
            <Text style={styles.primaryText}>Visit website</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
