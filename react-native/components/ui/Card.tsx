...
const Card: React.FC<CardProps> = ({
  ...
  const cardStyle = [
    ...
    {
      padding: typeof padding === 'number' ? padding : designTokens.spacing[padding],
      borderRadius: typeof borderRadius === 'number' ? borderRadius : designTokens.borderRadius[borderRadius],
    },
    style,
  ];
