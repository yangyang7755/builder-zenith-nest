-- Migration: Add saved_activities table
-- Run this in your Supabase SQL Editor if the saved_activities table doesn't exist
...
SELECT 'saved_activities table created successfully' as status;
